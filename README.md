...
| `--low-ram` | Enable low RAM mode with disk-based weight streaming and a 1GB RAM headroom. |

### Disk tier for model weights

When `--low-ram` is set, ComfyUI streams safetensors weights from disk and evicts weights to keep RAM usage within the low-RAM budget.
