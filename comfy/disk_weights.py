...
def evict_for_budget(target_device: torch.device, required_bytes: int):
    ...
    if target_device.type == "cpu":
        CACHE.evict_bytes(bytes_needed, target_device, lambda module, entry: _evict_module_weight(module, entry.name, entry.is_buffer))
        return
    ...
    def evict_to_cpu(module: torch.nn.Module, entry: CacheEntry):
        ...
        evict_for_budget(torch.device("cpu"), required_cpu)
